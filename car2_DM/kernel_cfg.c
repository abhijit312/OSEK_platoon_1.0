/*
 *  kernel_cfg.c
 *  Wed Apr 27 04:03:00 2016
 *  SG Version 2.00
 *  sg.exe car2_DM.oil -os=ECC2 -IC:/cygwin/nxtOSEK/toppers_osek/sg/impl_oil -template=C:/cygwin/nxtOSEK/toppers_osek/sg/lego_nxt.sgt
 */
...
const Priority tinib_inipri[TNUM_TASK] = { TPRI_MINTASK + 2, TPRI_MINTASK + 2, TPRI_MINTASK + 1, TPRI_MINTASK + 2, };
const Priority tinib_exepri[TNUM_TASK] = { TPRI_MINTASK + 2, TPRI_MINTASK + 2, TPRI_MINTASK + 1, TPRI_MINTASK + 2, };
...
const FP alminib_cback[TNUM_ALARM] = { _activate_alarm_sonar_sensor_alarm, _activate_alarm_motor_control_alarm, _activate_alarm_bluetooth_task_alarm, };
...
const TickType alminib_cycle[TNUM_ALARM] = { 25, 45, 60, };
