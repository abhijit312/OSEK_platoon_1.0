/*
 *  kernel_cfg.c
 *  Wed Apr 27 20:21:30 2016
 *  SG Version 2.00
 *  sg.exe car1_RM.oil -os=ECC2 -IC:/cygwin/nxtOSEK/toppers_osek/sg/impl_oil -template=C:/cygwin/nxtOSEK/toppers_osek/sg/lego_nxt.sgt
 */
...
const TickType alminib_cycle[TNUM_ALARM] = { 80, 60, };
